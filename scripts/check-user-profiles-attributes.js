...
async function checkUserProfilesAttributes() {
  ...
  try {
    ...
    console.log('📋 User Profiles Collection Info:');
    ...
    console.log('\n💡 Use only these attributes when creating/updating user profiles.');

  } catch (error) {
    console.error('❌ Error checking user_profiles collection:', error);
  }
}

checkUserProfilesAttributes();
